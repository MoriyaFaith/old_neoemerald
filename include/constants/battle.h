...
#define WEATHER_THUNDERSTORM_TEMPORARY      (1 << 9)
#define WEATHER_THUNDERSTORM_PERMANENT      (1 << 10)
#define WEATHER_THUNDERSTORM_ANY            (WEATHER_THUNDERSTORM_TEMPORARY | WEATHER_THUNDERSTORM_PERMANENT)
#define WEATHER_ANY                 (WEATHER_RAIN_ANY | WEATHER_SANDSTORM_ANY | WEATHER_SUN_ANY | WEATHER_HAIL_ANY | WEATHER_THUNDERSTORM_ANY)
...
#define ENUM_WEATHER_THUNDERSTORM   5
