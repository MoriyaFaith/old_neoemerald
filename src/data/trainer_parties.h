...
static const struct TrainerMonItemCustomMoves sParty_Roxanne1[] = {
    ...
    .species = SPECIES_GEODUDE,
    .heldItem = ITEM_NONE,
    .moves = {MOVE_ROCK_THROW, MOVE_MAGNITUDE, MOVE_ROCK_POLISH, MOVE_ROCK_TOMB}
    },
    {
    .iv = 100,
    .lvl = 13,
    .species = SPECIES_ARON,
    .heldItem = ITEM_NONE,
    .moves = {MOVE_HEADBUTT, MOVE_IRON_DEFENSE, MOVE_METAL_CLAW, MOVE_ROCK_TOMB}
    },
    {
    .iv = 200,
    .lvl = 15,
    ...
    .moves = {MOVE_SPARK, MOVE_THUNDER_WAVE, MOVE_ROCK_POLISH, MOVE_ROCK_TOMB}
    }
};
...
static const struct TrainerMonItemCustomMoves sParty_Brawly1[] = {
    ...
    .species = SPECIES_MACHOP,
    .heldItem = ITEM_NONE,
    .moves = {MOVE_KARATE_CHOP, MOVE_KNOCK_OFF, MOVE_REVENGE, MOVE_BULK_UP}
    },
    {
    .iv = 100,
    .lvl = 17,
    .species = SPECIES_MEDITITE,
    .heldItem = ITEM_NONE,
    .moves = {MOVE_FOCUS_PUNCH, MOVE_SUBSTITUTE, MOVE_THUNDER_PUNCH, MOVE_BULK_UP}
    },
    {
    .iv = 200,
    .lvl = 18,
...
static const struct TrainerMonItemCustomMoves sParty_Wattson1[] = {
    ...
    .species = SPECIES_ELECTRIKE,
    .heldItem = ITEM_NONE,
    .moves = {MOVE_SHOCK_WAVE, MOVE_THUNDER_WAVE, MOVE_BITE, MOVE_VOLT_SWITCH}
    },
    {
    .iv = 220,
    .lvl = 22,
    .species = SPECIES_MAGNETON,
    .heldItem = ITEM_NONE,
    .moves = {MOVE_MIRROR_SHOT, MOVE_SHOCK_WAVE, MOVE_THUNDER_WAVE, MOVE_VOLT_SWITCH}
    },
    {
    .iv = 250,
    .lvl = 24,
    .species = SPECIES_MANECTRIC,
    .heldItem = ITEM_SITRUS_BERRY,
    .moves = {MOVE_SHOCK_WAVE, MOVE_BITE, MOVE_ROAR, MOVE_VOLT_SWITCH}
    }
};
