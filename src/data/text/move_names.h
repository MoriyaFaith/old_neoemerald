const u8 gMoveNames[MOVES_COUNT][MOVE_NAME_LENGTH + 1] =
{
    ...
    [MOVE_HYPERSPACE_HOLE] = _("WORM HOLE"),
    [MOVE_WATER_SHURIKEN] = _("AQUASHURIKEN"),
    ...
    [MOVE_ELECTRIC_TERRAIN] = _("ZAP TERRAIN"),
    ...
    [MOVE_PSYCHIC_TERRAIN] = _("PSI TERRAIN"),
    [MOVE_LUNGE] = _("LUNGE"),
    ...
    [MOVE_SPECTRAL_THIEF] = _("SPECTR THIEF"),
    [MOVE_SUNSTEEL_STRIKE] = _("SUNS STRIKE"),
    ...
    [MOVE_BEHEMOTH_BLADE] = _("DOG BLADE"),
    [MOVE_BEHEMOTH_BASH] = _("DOG BASH"),
    ...
    [MOVE_MISTY_EXPLOSION] = _("MISTY BOOM"),
